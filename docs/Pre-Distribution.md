# MONETARYCOIN
## MonetaryCoinERO (MERO) AND MonetaryCoinCHI (MCHI) Distribution
...
## COMMAND LINE USAGE
It is assumed that participants have an Ethereum blockchain client installed. If you don't have the client installed, Parity could be a potential alternative though we neither recommend nor warranty Parity.
